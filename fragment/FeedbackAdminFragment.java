...
import com.example.unlimited_store.adapter.FeedbackAdapter;
...
public class FeedbackAdminFragment extends Fragment {
     ...
     * @return A new instance of fragment FeedbackAdmin.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list = new ArrayList<>();
        list.addAll(feedbackDAO.getAllFeedback());

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        rcvFeedback.setLayoutManager(linearLayoutManager);

        feedbackAdapter = new FeedbackAdapter(getContext(), list, feedbackDAO);
